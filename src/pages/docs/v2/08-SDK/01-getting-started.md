...
The pages that follow contain technical reference information on the Valueswap SDK.
...
The [source code is available on GitHub](https://github.com/valuenetworklive2021/valueswap-sdk).

## Dependencies

The SDK declares its dependencies as [peer dependencies](https://github.com/valuenetworklive2021/valueswap-sdk/blob/v2/package.json#L33).
