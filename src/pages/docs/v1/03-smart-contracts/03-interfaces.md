...
```solidity
interface ValueswapFactoryInterface {
    // Public Variables
...
```python
contract ValueswapFactoryInterface():
    # Create Exchange
...
```solidity
interface ValueswapExchangeInterface {
    // Address of ERC20 token sold on this exchange
    function tokenAddress() external view returns (address token);
    // Address of Valueswap Factory
...
```python
contract ValueswapExchangeInterface():
    # Public Variables
