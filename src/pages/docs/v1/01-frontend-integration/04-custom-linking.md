...
The Valueswap front-end supports URL query parameters to allow for custom linking to the Valueswap exchange. Users and developers can use these query parameters to link to the Valueswap exchange with custom prefilled settings.
...
`https://valuenetworklive2021.github.io/valueswap-interface/#/swap?theme=dark&use=v1`
...
`https://valuenetworklive2021.github.io/valueswap-interface/#/swap?exactField=input&exactAmount=10&inputCurrency=0x0F5D2fB29fb7d3CFeE444a200298f468908cC942?use=v1`
...
`https://valuenetworklive2021.github.io/valueswap-interface/#/send?recipient=0x74Aa01d162E6dC6A657caC857418C403D48E2D77?use=v1`
...
`https://valuenetworklive2021.github.io/valueswap-interface/#/add-liquidity?ethAmount=2.34&token=0x42456D7084eacF4083f1140d3229471bbA2949A8&tokenAmount=300?use=v1`
...
`https://valuenetworklive2021.github.io/valueswap-interface/#/remove-liquidity?poolTokenAmount=1.23&use=v1`
...
`https://valuenetworklive2021.github.io/valueswap-interface/#/swap?use=v1&create-exchange?tokenAddress=0x0F5D2fB29fb7d3CFeE444a200298f468908cC942`
...
`https://valuenetworklive2021.github.io/valueswap-interface/#/swap/0x0F5D2fB29fb7d3CFeE444a200298f468908cC942?exactField=input&exactAmount=10&use=v1`
