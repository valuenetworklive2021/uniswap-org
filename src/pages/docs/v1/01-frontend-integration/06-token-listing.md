...
It is possible that a token you are interested in is not included in the token dropdown on [https://valuenetworklive2021.github.io/valueswap-interface/#/swap?use=v1](https://valuenetworklive2021.github.io/valueswap-interface/#/swap?use=v1), however, all tokens that have a deployed Valueswap exchange are supported on the front-end.
...
[https://valuenetworklive2021.github.io/valueswap-interface/#/swap?use=v1](https://valuenetworklive2021.github.io/valueswap-interface/#/swap?use=v1) supports custom linking to all tokens that have a Valueswap exchange. See <Link to='/docs/v1/frontend-integration/custom-linking'>Custom Linking</Link> for details on how to link.
...
`https://valuenetworklive2021.github.io/valueswap-interface/#/swap?use=v1?outputCurrency=0xfA3E941D1F6B7b10eD84A0C211bfA8aeE907965e`
