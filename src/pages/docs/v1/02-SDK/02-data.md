...
This function fetches Valueswap reserve data for a given token address on a given network.
...
- This function throws an error if the provided tokenAddress is not a token with a Valueswap exchange.
...
| :---------------- | :------------------ | :------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| tokenAddress      | `string`            | The checksummed address of a token with a Valueswap exchange.                                                                                                                                                                            |
...
/*
{
  ...
  // details for the Valueswap exchange of the passed token
  exchange: {
    chainId: 1,
