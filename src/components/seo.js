...
function SEO({ description, lang, title, path }) {
  ...
  return (
    ...
    >
      ...
      <meta property="og:title" content={vntwTitle} />
      ...
      <meta name="twitter:creator" content="@ValueswapProtocol"></meta>
      <meta name="twitter:site" content="@ValueswapProtocol" />
      <meta property="og:image" content={`${site.siteMetadata.siteUrl}${path ? path : '/images/'}twitter-card.jpg`} />
